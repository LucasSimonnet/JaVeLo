...
public final class RouteComputer {
   ...
   public RouteComputer(Graph graph, CostFunction costFunction) {
    ...
    /**
     * Permet de sélectionner le noeud le plus proche  du noeud d'index indexN et de l'enregistrer comme étant checké
     *
     * @param indexN
     *          Index du noeud de départ
     * @param nodeDistance
     *          Tableau contenant pour chaque noeud la distance du plus court chemin pour parvenir à lui
     * @param predecessor
     *          Tableau contenant pour chaque noeud l'indice du noeud le précédant sur l'itinéraire
     * @param queue
     *          File stockant les noeuds en cours d'exploration
     * @param endNode
   ...
   private void checkNodeDistance(int indexN, double[] nodeDistance, int[] predecessor,
    ...
    /**
     * Permet de créer l'itinéraire partant du point de départ jusqu'au point d'arrivée en remontant
     * le tableau predecessor
     *
     * @param indexN
     *          Index d'un noeud
     * @param startNodeId
     *          Index du noeud de départ de l'itinéraire
     * @param predecessor
     *          Tableau contenant pour chaque noeud l'indice du noeud le précédant sur l'itinéraire
     *
     * @return l'itinéraire simple menant du point de départ au point d'arrivée
     */
