...
public final class RouteManager {
    ...
    /**
     * Permet de construire un gestionnaire d'itinéraire
     *
     * @param routeBean
    ...
    /**
     * Permet de replacer une forme déjà existante
     *
     * @param shape
     *      Forme à replacer
     *
     * @param differenceMap
     *      Difference entre les coordonnées précédentes et actuelles des points de la carte.
     */
    ...
    /**
     * Détermine les coordonnées sur le panneau du point en coordonnée Suisse
     *
     * @param point
     *      Point en coordonnée Suisse
     *
     * @return le point sur le panneau correspondant au point pris en argument
     */
    ...
    /**
     * @return le panneau JavaFX représentant l'itinéraire et le disque de mise en évidence
     */
    public Pane pane() {
