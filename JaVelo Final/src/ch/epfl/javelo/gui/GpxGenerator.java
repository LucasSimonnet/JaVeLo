...
public abstract class GpxGenerator implements Document {
    ...
    /**
     * Permet de creer le document Gpx correspondant à un itinéraire et son profil
     *
     * @param route
     *          Itinéraire
     * @param profile
    ...
    /**
     * Permet d'écrire le document Gpx correspondant à l'itinéraire et son profil dans un fichier
     *
     * @param name
     *          Nom d'un fichier
     * @param route
