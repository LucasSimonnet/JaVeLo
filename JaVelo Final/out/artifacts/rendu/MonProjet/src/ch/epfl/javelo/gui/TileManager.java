...
public final class TileManager {
    ...
    private static final int MAGIC_VALUE_TWO = 2;
    private static final int MIN_ZOOM = 0, MIN_X = 0, MIN_Y = 0;
    ...
    public Image imageForTileAt(TileId tileId) throws IOException {
        ...
        Path newFile = Path.of(path +"/"+tileId.zoomLevel+"/"+tileId.X+"/"+tileId.Y+".png");
    ...
    public record TileId(int zoomLevel, int X, int Y) {
        ...
        public static boolean isValid (int zoomLevel, double X, double Y) {
            ...
            double max = Math.pow(MAGIC_VALUE_TWO,zoomLevel) - 1 ;
    ...
    /**
     * Permet de savoir si le cache mémoire est remplie
     */
    private void isFull() {
