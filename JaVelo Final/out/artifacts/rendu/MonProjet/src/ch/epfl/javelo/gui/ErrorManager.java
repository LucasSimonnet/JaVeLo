...
public final class ErrorManager {
    ...
    /**
     * Permet de construire un gestionnaire utile à l'affichage des messages d'erreurs
     */
    public ErrorManager() {
        pane = new VBox();
    ...
    /**
     * Permet de retourner le panneau sur lequel apparaissent les messages d'erreur
     *
     ...
     *
     * @param message
     *      Chaîne de caractères représentant un  message d'erreu
     */
