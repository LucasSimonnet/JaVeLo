...
public final class ElevationProfileManager {
    ...
    /**
     * Permet de construire un gérant utile à l'affichage l'interaction avec le profil en long d'un itinéraire grâce
     * aux propriétés contenant le profile à afficher et la position le long du profil à mettre en évidence.
     *
     * @param profile
     *      Propriéte contenant le profile à afficher
     * @param position
    ...
    /**
     * Permet de dessiner la totalité du profil de la route
     */
    ...
    /**
     * Permet de créer la totalité des grilles
     */
    ...
    /**
     * Permet de créer le texte regroupant les statistiques du profil
     * @param p
     *      Représente un point sur le panneau
     *
     * @param text
     *      Représente la valeur des statistiques du profil
     * @param type
     *      Représente de quel type est le groupe de la grille
     */
    ...
    /**
     * Permet de de dessiner une ligne représentant la position mise en évidence
     */
    ...
    /**
     * Permet de stocker les dimensions du rectangle contenant le profil
     */
    ...
    /**
     *  Permet de créer les differentes transformations
     */
    ...
    /**
     * Permer de retourner une propriété en lecture seule contenant la position
     * du pointeur de la souris le long du profil
     *
    ...
    /**
     * Permet de créer le profil mis en evidence
     */
    ...
    /**
     * Permet de retourner le panneau contenant le dessin du profil
