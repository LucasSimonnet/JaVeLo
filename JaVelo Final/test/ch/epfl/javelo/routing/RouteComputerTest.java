...
import ch.epfl.javelo.gui.GpxGenerator;
...
public class RouteComputerTest {
    ...
    public static CostFunction cf = new CityBikeCF(g);
    public static RouteComputer rc = new RouteComputer(g, cf);
    public static Route r = rc.bestRouteBetween(2046055, 2694240);
    ...
    @Test
    void routeComputerComputesCorrectRouteForOtherExample() throws IOException {
        var rc = newLausanneRouteComputer();
    ...
    public static final class KmlPrinter {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //var rb = u.newLausanneRouteComputer();
        long t0 = System.nanoTime();
        //Route r = rb.bestRouteBetween(210641, 43713);
        //Route r = rb.bestRouteBetween(159049, 117669);
        Route r = rc.bestRouteBetween(2046055, 2694240);
        //Route r = rc.bestRouteBetween(159049, 117669);
        System.out.printf("Itinéraire calculé en %d ms\n",
                (System.nanoTime() - t0) / 1_000_000);
        RouteComputerTest.KmlPrinter.write("javelo.kml", r);
    }
